...
export default function Services() {
  ...
  return (
    <section ref={ref} className="relative isolate overflow-hidden py-20 px-6 bg-[#0a0a0a]">
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="hidden sm:block">
              <div className="max-w-[1360px] mx-auto grid sm:grid-cols-2 md:grid-cols-3 gap-12">
                {services.filter(service => service.showOnHome).slice(0, 6).map((service, index) => (
